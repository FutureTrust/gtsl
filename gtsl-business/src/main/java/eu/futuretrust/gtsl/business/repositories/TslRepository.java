...
public interface TslRepository extends MongoRepository<TslEntity, String> {

  TslEntity findById(String dbId);

  TslEntity findByHash(String hash);

  TslEntity findByTerritory(TerritoryEntity territoryEntity);
