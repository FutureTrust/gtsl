 ...
 */
public class MultiLangStringType extends NonEmptyString implements MultiLang {

  @NotNull(message = "{NotNull.multiLangString.lang}", payload = {Severity.Error.class, Impact.Legal.class})
  @Valid
  protected Lang lang;

  public MultiLangStringType() {
  }
  ...
  public MultiLangStringType(MultiLangStringTypeJAXB multiLang) {
    super(multiLang.getValue());
    this.lang = new Lang(multiLang.getLang());
  }

  public MultiLangStringTypeJAXB asJAXB() {
    MultiLangStringTypeJAXB multiLang = new MultiLangStringTypeJAXB();
    if (lang != null) {
